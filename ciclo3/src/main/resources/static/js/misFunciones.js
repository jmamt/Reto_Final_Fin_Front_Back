...
function guardarInformacionCategorias(){
    let var2 = {
        ...
        url:"http://129.151.116.117:8080/api/Category/save",
...
function traerInformacionFinca(){
    $.ajax({
        url:"http://129.151.116.117:8080/api/Farm/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionFinca(){
    let var3 = {
        ...
        url:"http://129.151.116.117:8080/api/Farm/save",
...
function traerInformacionClientes(){
    $.ajax({
        url:"http://129.151.116.117:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionClientes(){
    let var4 = {
        ...
        url:"http://129.151.116.117:8080/api/Client/save",
...
function traerInformacionMensajes(){
    $.ajax({
        url:"http://129.151.116.117:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionMensajes(){
    let var4 = {
        ...
        url:"http://129.151.116.117:8080/api/Message/save",
...
function traerInformacionReservacion(){
    $.ajax({
        url:"http://129.151.116.117:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionReservacion(){
    let var4 = {
        ...
        url:"http://129.151.116.117:8080/api/Reservation/save",
